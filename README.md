...
In the end, I analysed "top key phrases" from positive and negative comments using Spacy library. I overrode Spacy's methods to highlight chunks of Noun Phrases in the comments. The noun phrases are helpful in understanding the context and help infer what is being talked about in the sentence without having to read the full text. 
